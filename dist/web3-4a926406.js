...
const NETWORK_TYPES_URLS = new Map([['main', ETHERSCAN_URL], ['kovan', `kovan.${ETHERSCAN_URL}`], ['rinkeby', `rinkeby.${ETHERSCAN_URL}`], ['ropsten', `ropsten.${ETHERSCAN_URL}`], ['goerli', `goerli.${ETHERSCAN_URL}`], ['matic', POLYGON_URL], ['mumbai', `mumbai.${POLYGON_URL}`], ['harmony', `api.harmony.one`], ['harmonyTest', `api.s0.b.hmny.io`]]);
...
//# sourceMappingURL=web3-4a926406.js.map
