...
const NETWORK_TYPES_URLS = new Map([['main', ETHERSCAN_URL], ['kovan', `kovan.${ETHERSCAN_URL}`], ['rinkeby', `rinkeby.${ETHERSCAN_URL}`], ['ropsten', `ropsten.${ETHERSCAN_URL}`], ['goerli', `goerli.${ETHERSCAN_URL}`], ['matic', POLYGON_URL], ['mumbai', `mumbai.${POLYGON_URL}`], ['harmony', `explorer.harmony.one`], ['harmonyTest', `explorer.pops.one`]]);
const URL_TYPES = new Map([['block', 'block'], ['transaction', 'tx'], ['address', 'address'], ['token', 'token']]);
...
//# sourceMappingURL=web3-e13b67d7.js.map
