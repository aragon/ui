...
var injectStyles = function injectStyles(asset) {
  return styled.injectGlobal(_templateObject, asset(overpassLightWoff2), asset(overpassLightWoff), asset(overpassRegularWoff2), asset(overpassRegularWoff), asset(overpassSemiBoldWoff2), asset(overpassSemiBoldWoff), theme.textPrimary, theme.mainBackground);
};
...
var StyledIllustratedSection = styled__default(Section).withConfig({
...
var StyledIllustration = styled__default.div.withConfig({
...
var StyledSubtitle = styled__default.div.withConfig({
...
var StyledEmphasis = styled__default.div.withConfig({
...
var StyledContent$1 = styled__default.div.withConfig({
...
var modeStrong = styled.css(['', ';color:', ';background-image:linear-gradient(130deg,', ',', ');', ';&:after{background-image:linear-gradient( 130deg,', ',', ' );}'], plainButtonStyles, gradientText, gradientStart, gradientEnd, font({ size: 'small', weight: 'bold' }), gradientStartActive, gradientEndActive);
...
var compactStyle = styled.css(['padding:5px 15px;']);

var positiveStyle = styled.css(['padding-left:34px;background:url(', ') no-repeat 12px calc(50% - 1px);', ';'], styledPublicUrl(check), function (_ref) {
  var mode = _ref.mode;
...
var negativeStyle = styled.css(['padding-left:30px;background:url(', ') no-repeat 10px calc(50% - 1px);', ';'], styledPublicUrl(cross), function (_ref2) {
  var mode = _ref2.mode;
...
var Icon = styled__default.img.withConfig({
...
var StyledFooter = getPublicUrl(styled__default.footer.withConfig({
...
var Main$3 = getPublicUrl(styled__default.div.withConfig({
  displayName: 'PreFooter__Main'
})(['position:relative;overflow:hidden;background-color:', ';background-repeat:no-repeat;background-position:50% 50%;background-size:cover;background-image:url(', ');', ';'], colors.Rain.Shark, styledPublicUrl(bgPortrait), large$2(styled.css(['background-image:url(', ');'], styledPublicUrl(bgLandscape)))));

var Container = getPublicUrl(styled__default(Section).attrs({ visual: true }).withConfig({
...
var StyledMenuItem = styled__default.li.withConfig({
...
var PanelStyles = styled__default.div.withConfig({
...
var Toggle = styled__default.a.attrs({ role: 'button' }).withConfig({
...
var Container$2 = styled__default.span.withConfig({
...
var StyledHeader = styled__default.div.withConfig({
...
var StyledAragonApp = styled__default.main.withConfig({
  ...
  return backgroundLogo ? styled.css(['url(', ')'], styledPublicUrl(logo$3)) : 'none';
});
