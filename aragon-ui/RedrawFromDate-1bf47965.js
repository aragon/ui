...
var RedrawFromDate = /*#__PURE__*/function (_React$Component) {
  ...
  function RedrawFromDate() {
    ...
    defineProperty$1.defineProperty(getPrototypeOf.assertThisInitialized(_this), "clearInterval", function () {
      _this.interval && clearInterval(_this.interval);
    });

    defineProperty$1.defineProperty(getPrototypeOf.assertThisInitialized(_this), "restartDrawInterval", function (redrawTime) {
      _this.clearInterval();
...
defineProperty$1.defineProperty(RedrawFromDate, "propTypes", {
...
//# sourceMappingURL=RedrawFromDate-1bf47965.js.map
