import React$1, { useContext, useState, useEffect, useRef, useCallback } from 'react';
import { tokenIconUrl, fetchTokenData } from './utils.js';

const UseTokenContext = React$1.createContext(null);
...
function UseTokenProvider({ children  }) {
    ...
    return React$1.createElement(UseTokenContext.Provider, {
        value: {
