...
import React$1, { useCallback, useState, useEffect, useContext, useRef } from 'react';
...
var SidePanelContext = /*#__PURE__*/React$1.createContext(null);
...
var _StyledHeader = _styled$1("header").withConfig({
...
function SidePanel(_ref2) {
  ...
  return /*#__PURE__*/React$1.createElement(RootPortal$1, null, /*#__PURE__*/React$1.createElement(i, {
    name: "SidePanel"
  }, /*#__PURE__*/React$1.createElement(Transition, {
    items: opened,
    config: _objectSpread(_objectSpread({}, springs$1.lazy), {}, {
      precision: 0.001
    }),
    from: {
      progress: 0
    ...
    return opened && function (_ref4) {
      ...
      }, /*#__PURE__*/React$1.createElement(_StyledHeader, {
        _css3: 8 * GU,
        _css4: theme.border,
        _css5: unselectable()
      }, /*#__PURE__*/React$1.createElement(_StyledH, {
        _css6: theme.surfaceContent,
        _css7: textStyle('body1')
      }, title), !blocking && /*#__PURE__*/React$1.createElement(_StyledButtonIcon, {
        label: "Close",
        onClick: close,
        _css8: !compact ? "\n                              top: ".concat(2 * GU, "px;\n                              right: ").concat(2 * GU, "px;\n                            ") : "\n                              top: 0;\n                              right: 0;\n                              height: ".concat(8 * GU, "px;\n                              width: ").concat(8 * GU, "px;\n                            ")
      }, /*#__PURE__*/React$1.createElement(IconCross$1, {
        color: theme.surfaceIcon
      }))), /*#__PURE__*/React$1.createElement(_StyledDiv2, null, /*#__PURE__*/React$1.createElement(_StyledDiv3, null, /*#__PURE__*/React$1.createElement(SidePanelContext.Provider, {
        value: {
          status: status,
...
var _StyledAnimatedAside = _styled$1(extendedAnimated.aside).withConfig({
...
var Panel = /*#__PURE__*/React$1.memo(function Panel(_ref5) {
  var compact = _ref5.compact,
      props = objectWithoutProperties$1(_ref5, ["compact"]);

  var theme = useTheme();
  return /*#__PURE__*/React$1.createElement(_StyledAnimatedAside, _extends_1({}, props, {
    _css9: theme.surface,
