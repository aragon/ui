...
import FocusVisible$1 from '../FocusVisible/FocusVisible.js';
...
var _StyledAnimatedSpan = _styled$1(extendedAnimated.span).withConfig({
...
var Checkbox = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Checkbox() {
    ...
    defineProperty$1(assertThisInitialized$1(_this), "handleClick", function () {
    ...
    defineProperty$1(assertThisInitialized$1(_this), "focus", function () {
  ...
  createClass$1(Checkbox, [{
    ...
    value: function renderCheck(visible, Icon) {
      ...
      return /*#__PURE__*/React$1.createElement(Spring, {
        ...
        config: springs$1.instant,
        native: true
      }, function (_ref) {
        var progress = _ref.progress;
        return /*#__PURE__*/React$1.createElement(_StyledAnimatedSpan, {
          style: {
            opacity: progress,
    ...
    value: function render() {
      ...
      var _this$props4 = this.props,
          ...
          props = objectWithoutProperties$1(_this$props4, ["checked", "disabled", "indeterminate", "tabIndex", "theme", "variant"]);

      return /*#__PURE__*/React$1.createElement(FocusVisible$1, null, function (_ref2) {
        var focusVisible = _ref2.focusVisible,
            onFocus = _ref2.onFocus;
        return /*#__PURE__*/React$1.createElement(_StyledButton, _extends_1({
          type: "button",
          ref: _this2._element,
          role: variant,
          tabIndex: tabIndex,
        ...
        }), variant === 'checkbox' && _this2.renderCheck(checked && !indeterminate, Check), variant === 'checkbox' && _this2.renderCheck(indeterminate, Dash), variant === 'radio' && _this2.renderCheck(checked, Bullet), /*#__PURE__*/React$1.createElement(_StyledSpan, {
...
defineProperty$1(Checkbox, "propTypes", {
...
defineProperty$1(Checkbox, "defaultProps", {
  checked: false,
  disabled: false,
  indeterminate: false,
  onChange: noop,
...
var CheckBoxWithTheme = /*#__PURE__*/React$1.forwardRef(function (props, ref) {
  var theme = useTheme();
  return /*#__PURE__*/React$1.createElement(Checkbox, _extends_1({
    theme: theme,
    ref: ref
  }, props));
});
