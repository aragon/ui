...
import React$1, { useState, useCallback, useMemo, useEffect } from 'react';
...
import { ToggleButton as ToggleButton$1 } from './ToggleButton.js';
import { OpenedSurfaceBorder as OpenedSurfaceBorder$1 } from './OpenedSurfaceBorder.js';
...
var _StyledTable = _styled$1("table").withConfig({
...
function TableView(_ref3) {
  ...
  var headCells = useMemo(function () {
    return headingsFromFields(fields, {
      ...
      selectContent: /*#__PURE__*/React$1.createElement(CheckBoxWithTheme, {
  ...
  return /*#__PURE__*/React$1.createElement(_StyledTable, null, headCells && /*#__PURE__*/React$1.createElement("thead", null, /*#__PURE__*/React$1.createElement(HeadRow, {
    cells: headCells,
    selectedCount: selectedCount,
    renderSelectionCount: renderSelectionCount
  })), /*#__PURE__*/React$1.createElement("tbody", null, entries.map(function (entry, index) {
    return /*#__PURE__*/React$1.createElement(Entry, {
      key: entry.index,
...
function HeadRow(_ref4) {
  ...
  return /*#__PURE__*/React$1.createElement("tr", null, cells.map(function (cell, index) {
    var hidden = selectedCount > 0 && index > 1;
    var content = selectedCount > 0 && index === 1 ? renderSelectionCount(selectedCount) : cell[0];
    return !hidden && /*#__PURE__*/React$1.createElement(_StyledTh, {
      key: index,
...
var Entry = /*#__PURE__*/React$1.memo(function Entry(_ref5) {
  ...
  var cells = cellsFromEntry(entry, {
    ...
    selectable: selectable,
    toggleChildContent: hasAnyExpansion ? /*#__PURE__*/React$1.createElement(Toggle, {
      opened: opened,
      onToggle: handleToggle
    }) : null,
    selectContent: selectable ? /*#__PURE__*/React$1.createElement(CheckBoxWithTheme, {
      onChange: handleSelectChange,
      checked: entry.selected
    }) : null
  });
  return /*#__PURE__*/React$1.createElement(React$1.Fragment, null, /*#__PURE__*/React$1.createElement(EntryRow, {
    cells: cells,
    firstRow: firstRow,
    rowHeight: rowHeight,
    selected: entry.selected
  }), hasExpansion && /*#__PURE__*/React$1.createElement(EntryExpansion, {
...
var _StyledTr = _styled$1("tr").withConfig({
...
function EntryRow(_ref6) {
  ...
  var theme = useTheme();
  var sidePadding = useSidePadding();
  return /*#__PURE__*/React$1.createElement(_StyledTr, {
    _css8: selected ? theme.surfaceSelected : 'none'
  }, cells.map(function (_ref7, index, cells) {
    var _ref8 = slicedToArray$1(_ref7, 3),
        content = _ref8[0],
        align = _ref8[1],
        compact = _ref8[2];
    ...
    return /*#__PURE__*/React$1.createElement(_StyledTd, {
      key: index,
...
var _StyledTr2 = _styled$1("tr").withConfig({
...
function EntryExpansion(_ref9) {
  ...
  return /*#__PURE__*/React$1.createElement(Transition, {
    ...
    return show && function (_ref10) {
      ...
      return /*#__PURE__*/React$1.createElement(_StyledTr2, {
        _css15: theme.surfaceUnder
      }, alignChildOnCell > 0 && /*#__PURE__*/React$1.createElement("td", {
        colSpan: alignChildOnCell
      }, /*#__PURE__*/React$1.createElement(OpenedSurfaceBorder$1, {
        opened: opened
        ...
        return /*#__PURE__*/React$1.createElement(_StyledDiv2, {
          key: i,
      ...
      }, alignChildOnCell === 0 && /*#__PURE__*/React$1.createElement(OpenedSurfaceBorder$1, {
        opened: opened
...
var Toggle = /*#__PURE__*/React$1.memo(function Toggle(_ref11) {
  var opened = _ref11.opened,
      onToggle = _ref11.onToggle;
  return /*#__PURE__*/React$1.createElement(_StyledDiv4, null, /*#__PURE__*/React$1.createElement(OpenedSurfaceBorder$1, {
    opened: opened
  }), /*#__PURE__*/React$1.createElement(ToggleButton$1, {
    opened: opened,
    onClick: onToggle
  }));
});
