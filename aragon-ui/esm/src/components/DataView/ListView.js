...
function ListView(_ref) {
  ...
  return /*#__PURE__*/React$1.createElement(React$1.Fragment, null, entries.map(function (entry, index) {
    ...
    }), sideSpace && /*#__PURE__*/React$1.createElement(_StyledDiv2, {
      _css6: 1.5 * GU,
      _css7: 6.5 * GU
    }, selectable && /*#__PURE__*/React$1.createElement(Select, {
      index: entry.index,
      selected: entry.selected,
      onSelect: onSelect
    }), !selectable && hasExpansion && /*#__PURE__*/React$1.createElement(ToggleButton$1, {
      opened: entry.index === opened,
      onClick: function onClick() {
        return toggleEntry(entry.index);
      }
    })), entry.actions && /*#__PURE__*/React$1.createElement(_StyledDiv3, {
      _css8: 2 * GU,
      _css9: 3 * GU
    }, entry.actions), /*#__PURE__*/React$1.createElement("div", null, entry.entryNodes.map(function (content, index) {
    ...
    .sort(function (a, b) {
      ...
      var _ref3 = slicedToArray$1(_ref2, 2),
          content = _ref3[0],
          label = _ref3[1];

      return /*#__PURE__*/React$1.createElement(_StyledDiv4, {
        key: index,
      ...
      }, label), /*#__PURE__*/React$1.createElement("div", null, content));
  ...
  return /*#__PURE__*/React$1.createElement(Transition, {
    ...
    return show && function (_ref5) {
      ...
      return /*#__PURE__*/React$1.createElement(_StyledAnimatedDiv, {
        ...
        return /*#__PURE__*/React$1.createElement(_StyledDiv6, {
          key: i,
...
function Select(_ref6) {
  ...
  return /*#__PURE__*/React$1.createElement(CheckBoxWithTheme, {
    onChange: change,
    checked: selected
  });
}
