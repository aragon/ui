...
var _StyledCircle = _styled$1("circle").withConfig({
...
var LoadingRing = /*#__PURE__*/React$1.memo(function LoadingRing(_ref) {
  var paused = _ref.paused,
      modeProp = _ref.mode,
      props = objectWithoutProperties$1(_ref, ["paused", "mode"]);
  ...
  var _useState = useState(function () {
    return "sync-indicator-".concat(lastInstanceId++);
      ...
      _useState2 = slicedToArray$1(_useState, 1),
  ...
  })), insideFloatIndicator && /*#__PURE__*/React$1.createElement("circle", {
    cx: "50%",
    cy: "50%",
    r: size / 2,
    fill: "transparent",
  ...
  }, /*#__PURE__*/React$1.createElement(_StyledCircle, {
    cx: "50%",
    cy: "50%",
    r: size / 2,
    fill: "transparent",
