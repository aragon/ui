import React$1, { useRef, useImperativeHandle, useCallback } from 'react';
...
import IconCopy$1 from '../../icons/components/IconCopy.js';
...
var _StyledTextInput = _styled$1(WrapperTextInput).withConfig({
...
var TextCopy = /*#__PURE__*/React$1.memo( /*#__PURE__*/React$1.forwardRef(function TextCopy(_ref, ref) {
  var adornment = _ref.adornment,
      ...
      onCopy = _ref.onCopy,
      value = _ref.value,
      props = objectWithoutProperties$1(_ref, ["adornment", "autofocus", "message", "monospace", "onCopy", "value"]);
  ...
  }), adornment && /*#__PURE__*/React$1.createElement(_StyledDiv2, {
    _css3: theme.surface,
    _css4: theme.border
  }, /*#__PURE__*/React$1.createElement(_StyledDiv3, {
    _css5: HEIGHT - 2,
    _css6: HEIGHT - 2
  }, adornment)), /*#__PURE__*/React$1.createElement(_StyledTextInput, {
    ref: inputRef,
    adornment: /*#__PURE__*/React$1.createElement(_StyledButtonIcon, {
      onClick: handleCopy,
      label: "Copy",
      _css7: HEIGHT - 2,
      _css8: HEIGHT - 2,
      _css9: theme.surfaceIcon
    }, /*#__PURE__*/React$1.createElement(IconCopy$1, null)),
