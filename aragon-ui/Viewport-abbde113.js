...
var ViewportContext = /*#__PURE__*/React__default.createContext(WINDOW_SIZE_BASE);
...
var ViewportProvider = /*#__PURE__*/function (_React$Component) {
  ...
  function ViewportProvider() {
    ...
    defineProperty$1.defineProperty(getPrototypeOf.assertThisInitialized(_this), "updateWindowSize", function () {
      _this.setState({
        windowSize: _this.getWindowSize()
      });
    });

    defineProperty$1.defineProperty(getPrototypeOf.assertThisInitialized(_this), "within", function (min, max) {
    ...
    defineProperty$1.defineProperty(getPrototypeOf.assertThisInitialized(_this), "above", function (value) {
      return _this.within(value, -1);
    });

    defineProperty$1.defineProperty(getPrototypeOf.assertThisInitialized(_this), "below", function (value) {
...
defineProperty$1.defineProperty(ViewportProvider, "propTypes", {
  children: index.propTypes.node,
  throttle: index.propTypes.number
});

defineProperty$1.defineProperty(ViewportProvider, "defaultProps", {
  throttle: 100
});
...
//# sourceMappingURL=Viewport-abbde113.js.map
