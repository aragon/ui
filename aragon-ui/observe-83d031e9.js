  ...
  return function (Component) {
    ...
    return _temp = _class = /*#__PURE__*/function (_React$Component) {
      ...
      function _class() {
        ...
        defineProperty$1.defineProperty(getPrototypeOf.assertThisInitialized(_this), "state", initialState);

        defineProperty$1.defineProperty(getPrototypeOf.assertThisInitialized(_this), "subscribe", function (observable) {
          if (observable) {
            _this.setState({
        ...
        defineProperty$1.defineProperty(getPrototypeOf.assertThisInitialized(_this), "unsubscribe", function () {
      ...
      getPrototypeOf.createClass(_class, [{
        ...
        value: function render() {
          ...
          var props = _extends$1._extends_1({}, this.props); // Don't pass down the given observable


          delete props.observable;
          return /*#__PURE__*/React__default.createElement(Component, _extends$1._extends_1({}, this.state, props));
        }
      }]);

      return _class;
    }(React__default.Component), defineProperty$1.defineProperty(_class, "displayName", "Observe(".concat(getDisplayName.getDisplayName(Component), ")")), defineProperty$1.defineProperty(_class, "propTypes", {
...
//# sourceMappingURL=observe-83d031e9.js.map
