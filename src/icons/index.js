...
export { default as IconBylaw } from './components/Bylaw'
export { default as IconCheck } from './components/Check'
export { default as IconClose } from './components/Close'
export { default as IconCopy } from './components/Copy'
export { default as IconCross } from './components/Cross'
export { default as IconEllipsis } from './components/Ellipsis'
export { default as IconError } from './components/Error'
