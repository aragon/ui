...
const IconLock = ({ size, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M12 3a4.328 4.328 0 0 0-4.323 4.323v2.942a.646.646 0 0 0 1.293 0V7.323c0-1.67 1.359-3.03 3.03-3.03 1.671 0 3.03 1.36 3.03 3.03v2.942a.646.646 0 1 0 1.293 0V7.323A4.328 4.328 0 0 0 12 3z"
      />
    </svg>
  )
}
