...
const IconView = ({ size, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M12 9.017A2.987 2.987 0 0 0 9.017 12 2.987 2.987 0 0 0 12 14.983 2.987 2.987 0 0 0 14.983 12 2.987 2.987 0 0 0 12 9.017zm0 4.512A1.53 1.53 0 0 1 10.471 12c0-.843.686-1.53 1.53-1.53a1.53 1.53 0 0 1 0 3.058z"
      />
    </svg>
  )
}
